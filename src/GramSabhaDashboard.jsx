...
export default function GramSabhaDashboard({ onLogout }) {
  ...
  return (
    <div className="gram-sabha-dashboard-bg" style={{ display: "flex" }}>
      ...
      <main style={{ flex: 1, padding: 32 }}>
        ...
        >
          <h1 style={{ fontSize: 28, fontWeight: 700 }}>Gram Sabha Members</h1>
          <div
          ...
          >
            ...
            {isOpen && (
              ...
              >
                <button
                  style={menuItemStyle}
                  onClick={() => alert("View or edit Gram Sabha profile")}
                >
                  Profile
                </button>
                <button
        ...
        >
          ...
          <p style={{ color: "#666", marginBottom: 24 }}>
            Upload a scanned FRA claim document to begin the digitization and
