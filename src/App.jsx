    ...
    return (
      <div className="login-container">
        <div className="login-card">
          <div style={{ textAlign: 'center', marginBottom: 24 }}>
            <img src="/logo.jpg" alt="Logo"
                 style={{ width: 85, height: 85, display: 'block',
                          margin: '0 auto 12px auto', objectFit: 'contain' }} />
            <h1 style={{ fontSize: 26, fontWeight: 700, margin: 0, color: '#222' }}>FRA Digitizer</h1>
            <h1 style={{ fontSize: 16, fontWeight: 400, margin: 0, color: '#222' }}>Sign in to your accunt to continue</h1>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-gray-500 mt-4">
                ...
                style={{ color: "Green", textDecoration: "underline" }}
                 onClick={() => setView("forgot")}>Forgot password?</button>
              </p>
          ...
          {view === "signup" && (
            <form onSubmit={e => { e.preventDefault(); alert("Sign-up logic here"); setView("login"); }} className="space-y-4">
              {EmailInput}
              {PasswordInput}
              <div>
          ...
          {view === "forgot" && (
            <form onSubmit={e => { e.preventDefault(); alert("Password reset link sent"); setView("login"); }} className="space-y-4">
              {EmailInput}
